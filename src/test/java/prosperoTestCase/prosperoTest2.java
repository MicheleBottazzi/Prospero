...
public class prosperoTest2{
    ...
    public void Test() throws Exception {
        ...
        String inPathToLWRad 			="resources/Input/dataET_point/ShortWaveRadiationDiffuse.csv";
        String inPathToSoilHeatFlux 	="resources/Input/dataET_point/ShortWaveRadiationDiffuse.csv";


        String inPathToPressure 		="resources/Input/dataET_point/ShortWaveRadiationDiffuse.csv";
        String inPathToLai 				="resources/Input/dataET_point/LeafAreaIndex4.csv";
		...
		String outPathToSun				="resources/Output/RadSun4.csv";
		String outPathToShadow			="resources/Output/RadShadow4.csv";
		String outPathToCanopy			="resources/Output/Canopy4.csv";
